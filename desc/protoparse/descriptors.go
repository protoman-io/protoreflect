...
func (s srcLocs) ByPath(path protoreflect.SourcePath) protoreflect.SourceLocation {
	return protoreflect.SourceLocation{}
}

func (s srcLocs) ByDescriptor(desc protoreflect.Descriptor) protoreflect.SourceLocation {
	return protoreflect.SourceLocation{}
}
...
func (f *fldDescriptor) HasPresence() bool {
	return f.Syntax() == protoreflect.Proto3 && f.HasOptionalKeyword()
}
...
func (o oneofDescriptor) Fields() protoreflect.FieldDescriptors {
	...
	for _, fld := range o.parent.proto.GetField() {
		if int(fld.GetOneofIndex()) == o.index {
